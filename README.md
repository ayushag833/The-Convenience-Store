•	The Convenience Store, an e-commerce web app facilitating browsing and purchasing various products. Built with React.JS and styled using Tailwind CSS for a streamlined user interface.
